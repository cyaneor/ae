...
ae_memory_raw_fill(void *begin, const void *end, ae_u8_t value)
{
    ...
    else if (ae_ptr_range_is_aligned(begin, end, AE_U32_T_SIZE))
    {
        return ae_memory_raw_fill32(begin, end, value);
    }
    else if (ae_ptr_range_is_aligned(begin, end, AE_U16_T_SIZE))
    {
...
ae_memory_raw_copy(void       *dest_begin,
                   ...
                   const void *src_end)
{
    if (ae_ptr_range_is_aligned(dest_begin, dest_end, AE_U64_T_SIZE) &&
        ae_ptr_range_is_aligned(src_begin, src_end, AE_U64_T_SIZE))
    {
        return ae_memory_raw_copy64(dest_begin, dest_end, src_begin, src_end);
    }
    else if (ae_ptr_range_is_aligned(dest_begin, dest_end, AE_U32_T_SIZE) &&
             ae_ptr_range_is_aligned(src_begin, src_end, AE_U32_T_SIZE))
    {
        return ae_memory_raw_copy32(dest_begin, dest_end, src_begin, src_end);
    }
    else if (ae_ptr_range_is_aligned(dest_begin, dest_end, AE_U16_T_SIZE) &&
             ae_ptr_range_is_aligned(src_begin, src_end, AE_U16_T_SIZE))
    {
...
ae_memory_raw_move64(ae_u64_t       *dest_begin,
                     ...
                     const ae_u64_t *src_end)
{
    return ae_ptr_range_overlap_check(dest_begin, dest_end, src_begin, src_end)
...
ae_memory_raw_compare(const void *lhs_begin,
                      ...
                      const void *rhs_end)
{
    if (ae_ptr_range_is_aligned(lhs_begin, lhs_end, AE_U64_T_SIZE) &&
        ae_ptr_range_is_aligned(rhs_begin, rhs_end, AE_U64_T_SIZE))
    {
        return ae_memory_raw_compare64(lhs_begin, lhs_end, rhs_begin, rhs_end);
    }
    else if (ae_ptr_range_is_aligned(lhs_begin, lhs_end, AE_U32_T_SIZE) &&
             ae_ptr_range_is_aligned(rhs_begin, rhs_end, AE_U32_T_SIZE))
    {
        return ae_memory_raw_compare32(lhs_begin, lhs_end, rhs_begin, rhs_end);
    }
    else if (ae_ptr_range_is_aligned(lhs_begin, lhs_end, AE_U16_T_SIZE) &&
             ae_ptr_range_is_aligned(rhs_begin, rhs_end, AE_U16_T_SIZE))
    {
...
{
    if (ae_ptr_range_is_aligned(haystack_begin, haystack_end, AE_U64_T_SIZE) &&
        ae_ptr_range_is_aligned(needle_begin, needle_end, AE_U64_T_SIZE))
    {
        return ae_memory_raw_find64(haystack_begin, haystack_end, needle_begin, needle_end);
    }
    else if (ae_ptr_range_is_aligned(haystack_begin, haystack_end, AE_U32_T_SIZE) &&
             ae_ptr_range_is_aligned(needle_begin, needle_end, AE_U32_T_SIZE))
    {
        return ae_memory_raw_find32(haystack_begin, haystack_end, needle_begin, needle_end);
    }
    else if (ae_ptr_range_is_aligned(haystack_begin, haystack_end, AE_U16_T_SIZE) &&
             ae_ptr_range_is_aligned(needle_begin, needle_end, AE_U16_T_SIZE))
    {
