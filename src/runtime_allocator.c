...
ae_memory_allocator_t ae_runtime_allocator = ae_memory_allocator_initializer(malloc, free);
#else
AE_ATTRIBUTE(THREAD_LOCAL)
ae_memory_allocator_t ae_runtime_allocator = ae_memory_allocator_initializer(nullptr, nullptr);
