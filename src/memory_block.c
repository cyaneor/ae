...
#include <ae/memory_block_cast.h>
...
ae_memory_block_size(const ae_memory_block_t *self)
{
    ae_runtime_try
    {
        ...
        ae_runtime_try_interrupt(
            ae_memory_range_size(ae_memory_range_cast(self, const), element_size));
    }
...
ae_memory_block_swap(struct ae_memory_block *self, struct ae_memory_block *other)
{
    ...
    ae_memory_range_swap(ae_memory_range_cast(self), ae_memory_range_cast(other));
}

void
ae_memory_block_clear(ae_memory_block_t *self)
{
    ae_memory_range_clear(ae_memory_range_cast(self));
}
...
ae_memory_block_exchange(ae_memory_block_t *self, ae_memory_block_t *other)
{
    ...
    ae_memory_range_exchange(ae_memory_range_cast(self), ae_memory_range_cast(other));
}
...
ae_memory_block_element_base_address(const struct ae_memory_block *self, const void *ptr)
{
    ...
    AE_RUNTIME_ASSERT(ae_memory_range_has_ptr(ae_memory_range_cast(self, const), ptr, true),
    ...
    const void *begin = ae_memory_range_begin_const(ae_memory_range_cast(self, const));
...
ae_memory_block_at_from_begin(ae_memory_block_t *self, ae_usize_t index)
{
    ae_runtime_try
    {
        ...
        ae_runtime_try_interrupt(ae_memory_range_at(ae_memory_range_cast(self), offset));
    }
...
{
    return ae_memory_block_at_from_begin(ae_memory_block_cast(self), index);
}
...
{
    return ae_memory_block_at(ae_memory_block_cast(self), index, reversed);
}
...
{
    return ae_memory_block_front(ae_memory_block_cast(self));
}
...
{
    return ae_memory_block_back(ae_memory_block_cast(self));
}
...
ae_memory_block_equal(const ae_memory_block_t *self, const ae_memory_block_t *other)
{
    return ae_memory_block_element_size_equal(self, other) &&
           ae_memory_range_equal(ae_memory_range_cast(self, const),
                                 ae_memory_range_cast(other, const));
}
