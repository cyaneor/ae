...
ae_dynamic_block_total_size(const ae_dynamic_block_t *self)
{
    ...
    const ae_usize_t element_size =
        ae_memory_block_get_element_size(ae_ptr_cast(const ae_memory_block_t, self));
...
{
    void *begin = ae_memory_range_get_begin(ae_ptr_cast(ae_memory_range_t, self));
...
bool
ae_dynamic_block_is_equal_size_to(const ae_dynamic_block_t *self, ae_usize_t size)
{
    return ae_dynamic_block_size(self) == size;
}

bool
ae_dynamic_block_is_equal_size(const ae_dynamic_block_t *self, const ae_dynamic_block_t *other)
{
    const ae_usize_t size = ae_dynamic_block_size(other);
    return ae_dynamic_block_is_equal_size_to(self, size);
}

bool
ae_dynamic_block_is_equal(const ae_dynamic_block_t *self, const ae_dynamic_block_t *other)
{
    return ae_dynamic_block_is_equal_size(self, other) &&
           ae_aligned_block_is_equal(ae_ptr_cast(const ae_aligned_block_t, self),
