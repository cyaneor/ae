 ...
 *
 * Этот файл предоставляет макрос `ae_static_assert`,
...
#ifndef AE_STATIC_ASSERT_H
#define AE_STATIC_ASSERT_H

/**
 * @def ae_static_assert
 ...
 * @code
 * ae_static_assert(sizeof(int) == 4, "Размер типа int должен быть 4 байта");
 * @endcode
 */
#define ae_static_assert(expr, msg) _Static_assert(expr, msg)

#endif // AE_STATIC_ASSERT_H
