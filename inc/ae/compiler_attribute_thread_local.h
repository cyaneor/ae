 ...
 *
 * Этот файл предоставляет макрос `AE_COMPILER_ATTRIBUTE_THREAD_LOCAL` для указания атрибута
 ...
 *
 * Макрос:
 * - `AE_COMPILER_ATTRIBUTE_THREAD_LOCAL`:
...
#ifndef AE_COMPILER_ATTRIBUTE_THREAD_LOCAL_H
#define AE_COMPILER_ATTRIBUTE_THREAD_LOCAL_H

#include "compiler_type.h"

#if (AE_COMPILER_TYPE == AE_COMPILER_TYPE_GCC) || (AE_COMPILER_TYPE == AE_COMPILER_TYPE_CLANG)
/**
 * @def AE_COMPILER_ATTRIBUTE_THREAD_LOCAL
 ...
 */
#    define AE_COMPILER_ATTRIBUTE_THREAD_LOCAL __thread
 ...
 */
#    define AE_COMPILER_ATTRIBUTE_THREAD_LOCAL __declspec(thread)
 ...
 */
#    define AE_COMPILER_ATTRIBUTE_THREAD_LOCAL

#    pragma message("Warning: Compiler does not support thread-local storage attribute")
#endif

#endif // AE_COMPILER_ATTRIBUTE_THREAD_LOCAL_H
