 ...
 * - Проверка, является ли число четным: `AE_BIT_IS_EVEN(x)`
 * - Установка бита: `AE_BIT_SET(bit, x)`
 * - Очистка бита: `AE_BIT_CLEAR(bit, x)`
 * - Переключение бита: `AE_BIT_TOGGLE(bit, x)`
 * - Проверка состояния бита: `AE_BIT_CHECK(bit, x)`
 *
 ...
 */
#define ae_bit_is_single(x) ((x) != 0 && ((x) & ((x) - 1)) == 0)
 ...
 */
#define ae_bit_set(bit, x) ((x) | (1 << (bit)))
 ...
 */
#define ae_bit_clear(bit, x) ((x) & ~(1 << (bit)))
 ...
 */
#define ae_bit_toggle(bit, x) ((x) ^ (1 << (bit)))
 ...
 */
#define ae_bit_check(bit, x) (((x) & (1 << (bit))) != 0)
 ...
 */
#define ae_bit_mask(num_bits) ((1 << (num_bits)) - 1)
 ...
 */
#define ae_bit_is_odd(x) (((x) & 1) != 0)

/**
 * @def ae_bit_shift_left
 ...
 */
#define ae_bit_shift_left(x, n) ((x) << (n))

/**
 * @def ae_bit_shift_right
 ...
 */
#define ae_bit_shift_right(x, n) ((x) >> (n))

/**
 * @def ae_bit_rotate_left
 ...
 */
#define ae_bit_rotate_left(x, n) (((x) << (n)) | ((x) >> (sizeof(x) * 8 - (n))))

/**
 * @def ae_bit_rotate_right
 ...
 * @warning Убедитесь, что значение `n` не превышает количество битов в типе `x`.
 */
#define ae_bit_rotate_right(x, n) (((x) >> (n)) | ((x) << (sizeof(x) * 8 - (n))))

/**
 * @def ae_bit_set_by_index
 ...
 */
#define ae_bit_set_by_index(x, i) ((x) |= (1ULL << (i)))

/**
 * @def ae_bit_clear_by_index
 ...
 * @warning Убедитесь, что значение `i` не превышает количество битов в типе `x`.
 */
#define ae_bit_clear_by_index(x, i) ((x) &= ~(1ULL << (i)))

/**
 * @def ae_bit_toggle_by_index
 ...
 * @warning Убедитесь, что значение `i` не превышает количество битов в типе `x`.
 */
#define ae_bit_toggle_by_index(x, i) ((x) ^= (1ULL << (i)))

/**
 * @def ae_bit_check_by_index
 ...
 * @warning Убедитесь, что значение `i` не превышает количество битов в типе `x`.
 */
#define ae_bit_check_by_index(x, i) ((x) & (1ULL << (i)))

/**
 * @def ae_bit_change_by_index
