 ...
 *
 * Этот файл содержит макрос `ae_reinterpret_cast`, который позволяет
 * безопасно выполнять приведение типов в зависимости от того,
 * компилируется ли код с использованием C++ или C.
 */

#ifndef AE_REINTERPRET_CAST_H
#define AE_REINTERPRET_CAST_H
 ...
 */
#    define ae_reinterpret_cast(T, V) reinterpret_cast<T>(V)
#else
/**
 * @brief Приведение типов в C.
 *
 ...
 * @return Приведенное значение типа T.
 */
#    define ae_reinterpret_cast(T, V) ((T)V)
#endif // __cplusplus

#endif // AE_REINTERPRET_CAST_H