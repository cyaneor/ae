 ...
 * @see ae_memory_range
 * @see ae_memory_range_total_size
 * @see ae_memory_range_is_multiple_of_total_size
 */
AE_ATTRIBUTE(SYMBOL)
ae_usize_t
 ...
 * @see ae_memory_range_get_end
 * @see ae_memory_range_set
 */
AE_ATTRIBUTE(SYMBOL)
void
 ...
 * корректным с помощью функции `ae_memory_range_is_valid`. Если диапазон
 ...
 * После этого вызывается функция `ae_memory_range_set_with_validate`
 ...
 *
 * @see ae_memory_range
 * @see ae_memory_range_set_with_validate
 */
AE_ATTRIBUTE(SYMBOL)
void
 ...
 *        Если указатель на `self` равен `null`.
 *
 * @see ae_memory_range_set_with_size
 ...
 *
 * @see ae_memory_range
 * @see ae_memory_range_is_begin_equal_to
 */
AE_ATTRIBUTE(SYMBOL)
bool
 ...
 *
 * @see ae_memory_range
 * @see ae_memory_range_is_end_equal_to
 */
AE_ATTRIBUTE(SYMBOL)
bool
 ...
 *
 * @see ae_memory_range
 * @see ae_memory_range_is_begin_equal
 * @see ae_memory_range_is_end_equal
 */
AE_ATTRIBUTE(SYMBOL)
bool
