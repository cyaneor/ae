...
/**
 * @def AE_U128_T_SIZE
 * @brief Размер беззнакового 128-битного целого числа.
 *
 * Этот макрос переназначает `AE_U128_T_SIZE` на значение, определённое макросом `AE_INT128_T_SIZE`,
 * если размер типа `ae_uint128_t` равен 16 байтам (128 бит).
 * Доступен только при условии, что макрос `AE_INT128_T_SIZE` определён и равен 16.
 */
#define AE_U128_T_SIZE AE_INT128_T_SIZE

/**
 * @def AE_U128_T_MIN
 * @brief Минимальное значение для беззнакового 128-битного целого числа.
 *
 * Этот макрос переназначает `AE_U128_T_MIN` на значение, определённое макросом `AE_UINT128_T_MIN`,
 * если размер типа `ae_uint128_t` равен 16 байтам (128 бит).
 * Доступен только при условии, что макрос `AE_INT128_T_SIZE` определён и равен 16.
 */
#    define AE_U128_T_MIN AE_UINT128_T_MIN

/**
 * @def AE_U128_T_MAX
 * @brief Максимальное значение для беззнакового 128-битного целого числа.
 *
 * Этот макрос переназначает `AE_U128_T_MAX` на значение, определённое макросом `AE_UINT128_T_MAX`,
 * если размер типа `ae_uint128_t` равен 16 байтам (128 бит).
 * Доступен только при условии, что макрос `AE_INT128_T_SIZE` определён и равен 16.
 */
#    define AE_U128_T_MAX AE_UINT128_T_MAX

/**
 * @def AE_S128_T_SIZE
 * @brief Размер знакового 128-битного целого числа.
 *
 * Этот макрос переназначает `AE_S128_T_SIZE` на значение, определённое макросом `AE_INT128_T_SIZE`,
 * если размер типа `ae_sint128_t` равен 16 байтам (128 бит).
 * Доступен только при условии, что макрос `AE_INT128_T_SIZE` определён и равен 16.
 */
#define AE_S128_T_SIZE AE_INT128_T_SIZE

/**
 * @def AE_S128_T_MIN
 * @brief Минимальное значение для знакового 128-битного целого числа.
 *
 * Этот макрос переназначает `AE_S128_T_MIN` на значение, определённое макросом `AE_SINT128_T_MIN`,
 * если размер типа `ae_sint128_t` равен 16 байтам (128 бит).
 * Доступен только при условии, что макрос `AE_INT128_T_SIZE` определён и равен 16.
 */
#    define AE_S128_T_MIN AE_SINT128_T_MIN

/**
 * @def AE_S128_T_MAX
 * @brief Максимальное значение для знакового 128-битного целого числа.
 *
 * Этот макрос переназначает `AE_S128_T_MAX` на значение, определённое макросом `AE_SINT128_T_MAX`,
 * если размер типа `ae_sint128_t` равен 16 байтам (128 бит).
 * Доступен только при условии, что макрос `AE_INT128_T_SIZE` определён и равен 16.
 */
#    define AE_S128_T_MAX AE_SINT128_T_MAX
#endif
