...
AE_ATTRIBUTE(SYMBOL)
ae_usize_t
ae_memory_block_get_element_size(const ae_memory_block_t *self);
 ...
 * @ref ae_memory_block_get_element_size для получения размера элемента
...
AE_ATTRIBUTE(SYMBOL)
bool
ae_memory_block_is_empty(const ae_memory_block_t *self);
...
AE_ATTRIBUTE(SYMBOL)
bool
ae_memory_block_is_element_size_equal_to(const struct ae_memory_block *self,
 ...
 * Она использует функцию @ref ae_memory_block_is_element_size_equal_to для сравнения.
 *
 ...
 *        Если указатель на `self` равен `null`.
 *
 * @see ae_memory_block_is_element_size_equal_to
 */
AE_ATTRIBUTE(SYMBOL)
bool
ae_memory_block_is_element_size_equal(const struct ae_memory_block *self,
 ...
 *
 * @see ae_memory_block_is_element_size_equal
 * @see ae_memory_range_is_equal
 * @see ae_memory_block
 */
AE_ATTRIBUTE(SYMBOL)
bool
ae_memory_block_is_equal(const ae_memory_block_t *self, const ae_memory_block_t *other);
