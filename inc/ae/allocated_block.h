 ...
 *
 * Данный файл содержит определение структуры `ae_allocated_block` и функции
 * для управления блоками динамически выделенной памяти. Структура предоставляет
 * механизм для работы с блоками памяти фиксированного размера элементов.
 *
