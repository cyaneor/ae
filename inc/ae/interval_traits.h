 ...
 */
#define ae_interval_is_valid_closed(lower, upper) (lower <= upper)

/**
 * @def ae_interval_is_valid_left_opened
 ...
 *         что истинно, если интервал валиден.
 */
#define ae_interval_is_valid_left_opened(lower, upper) (lower < upper)

/**
 * @def ae_interval_is_valid_right_opened
 ...
 *         что истинно, если интервал валиден.
 */
#define ae_interval_is_valid_right_opened(lower, upper) (lower <= upper)

/**
 * @def ae_interval_is_valid_opened
 ...
 *         что истинно, если интервал валиден.
 */
#define ae_interval_is_valid_opened(lower, upper) (lower < upper)

/**
 * @def ae_interval_has_closed
 ...
 */
#define ae_interval_has_closed(lower, upper, value) ((value) >= (lower) && (value) <= (upper))

/**
 * @def ae_interval_has_left_opened
 ...
 *         и `false` в противном случае.
 */
#define ae_interval_has_left_opened(lower, upper, value) ((value) > (lower) && (value) <= (upper))

/**
 * @def ae_interval_has_right_opened
 ...
 *         и `false` в противном случае.
 */
#define ae_interval_has_right_opened(lower, upper, value) ((value) >= (lower) && (value) < (upper))

/**
 * @def ae_interval_has_opened
