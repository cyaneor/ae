 ...
 */
#ifndef AE_RUNTIME_RETURN_IF_H
#define AE_RUNTIME_RETURN_IF_H

#include "runtime_return.h"

/**
 * @def ae_runtime_return_if
 ...
 */
#define ae_runtime_return_if(expr, ...)                                                            \
    if (expr)                                                                                      \
    ae_runtime_return(__VA_ARGS__)

/**
 * @def ae_runtime_return_if_not
 ...
 *          чтобы избежать ошибок компиляции или неопределенного поведения.
 */
#define ae_runtime_return_if_not(expr, ...) ae_runtime_return_if(!(expr), __VA_ARGS__)

#endif // AE_RUNTIME_RETURN_IF_H
