...
typedef enum ae_runtime_error_code
{
    ...
    /**
     * @brief Ошибка: недопустимый диапазон.
     *
     * Возникает, когда переданный диапазон значений является недопустимым.
     * Например, попытка обращения к диапазону, который выходит за допустимые пределы
     * или нарушает внутренние ограничения, связанные с обработкой данных.
     */
    AE_ERROR_INVALID_RANGE,
