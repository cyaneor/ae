 ...
 *
 * Эта функция устанавливает код ошибки в объект ошибки, представленный указателем `self`.
 * Перед установкой кода ошибки выполняется проверка на null указателя.
 *
 ...
 *
 * Эта функция устанавливает описание ошибки в объект ошибки, представленный указателем `self`.
 * Перед установкой описания выполняется проверка на null указателя.
 *
 * @param[in] self Указатель на объект ошибки.
