 ...
 *
 * Эта функция находит первое вхождение символа терминатора NULL (0) в строке, не требуя явного
 * указания длины строки. Длина строки рассчитывается автоматически на основе максимального
 * возможного значения для типа размера, вычитая адрес начала строки.
 *
 * @param[in] str Указатель на строку, в которой будет произведен поиск.
 *
 * @return Указатель на символ терминатора NULL в строке,
