 ...
 *
 * Функция перемещает данные из источника в указанное место назначения,
 * используя указанные длины строк. Преобразует входные параметры
 * в указатели на байты и выполняет перемещение данных между ними.
 *
 * @param[in] str Указатель на целевую строку,
 *                в которую будет произведено перемещение данных.
 * @param[in] str_len Длина целевой строки.
 * @param[in] src Указатель на исходную строку,
 *                из которой будет происходить перемещение данных.
