...
/**
 * @def ae_numeric_u32_constant(c)
 * @brief Преобразует целочисленное значение в 32-битную беззнаковую константу.
 *
 * Этот макрос принимает целочисленное значение и добавляет суффикс 'UL',
 * чтобы указать, что это 32-битная беззнаковая константа.
 *
 * @param c Целочисленное значение, которое будет преобразовано.
 * @return 32-битная беззнаковая константа.
 *
 * @note Используйте этот макрос для явного указания,
 *       что значение является беззнаковым целым числом.
 */
#define ae_numeric_u32_constant(c) (c##UL)

/**
 * @def ae_numeric_u64_constant(c)
 * @brief Преобразует целочисленное значение в 64-битную беззнаковую константу.
 *
 * Этот макрос принимает целочисленное значение и добавляет суффикс 'ULL',
 * чтобы указать, что это 64-битная беззнаковая константа.
 *
 * @param c Целочисленное значение, которое будет преобразовано.
 * @return 64-битная беззнаковая константа.
 *
 * @note Используйте этот макрос для явного указания,
 *       что значение является беззнаковым целым числом.
 */
#define ae_numeric_u64_constant(c) (c##ULL)

/**
 * @def ae_numeric_min
 * @brief Возвращает минимальное значение из двух чисел.
 * @details Этот макрос принимает два аргумента и возвращает меньшее из них.
 *
 * @param a Первое число для сравнения.
 * @param b Второе число для сравнения.
 * @return Меньшее из двух чисел.
 */
#define ae_numeric_min(a, b) ((a) < (b) ? (a) : (b))

/**
 * @def ae_numeric_max
 * @brief Возвращает максимальное значение из двух чисел.
 * @details Этот макрос принимает два аргумента и возвращает большее из них.
 *
 * @param a Первое число для сравнения.
 * @param b Второе число для сравнения.
 * @return Большее из двух чисел.
 */
#define ae_numeric_max(a, b) ((a) > (b) ? (a) : (b))
