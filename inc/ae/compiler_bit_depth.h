 ...
 *
 * Этот файл предоставляет макрос `AE_COMPILER_BIT_DEPTH`,
...
#ifndef AE_COMPILER_BIT_DEPTH_H
#define AE_COMPILER_BIT_DEPTH_H

#if defined(_WIN64)
/**
 * @def AE_COMPILER_BIT_DEPTH
 * @brief Макрос, определяющий разрядность компилятора
 *        как 64-битную на 64-битных системах Windows.
 */
#    define AE_COMPILER_BIT_DEPTH 64
#elif defined(_WIN32)
/**
 * @def AE_COMPILER_BIT_DEPTH
 * @brief Макрос, определяющий разрядность компилятора
 ...
 */
#    define AE_COMPILER_BIT_DEPTH 32
