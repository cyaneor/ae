...
# макросов, представляющих числовые ограничения для различных пользовательских типов AE библиотеки.  #
...
# В результате создается `numeric_limits.h` с макросами, определяющими минимальные и максимальные    #
# значения, а также размеры различных знаковых и беззнаковых типов данных.                           #
# -------------------------------------------------------------------------------------------------- #

# Этот файл генерирует ограничения в виде макросов для собственных типов AE библиотеки.
include(CheckCSourceRuns)

# Создаем переменную с путем, по которому будут генерироваться ограничения.
set(AE_NUMERIC_LIMITS_OUTPUT_FILE "${AE_TARGET_INCLUDE_DIRECTORIES}/${PROJECT_NAME}/numeric_limits.h")

# Создание исходного кода в переменную.
set(AE_NUMERIC_LIMITS_SOURCE_CODE "
#include <stdio.h>
#include <errno.h>
#include \"${AE_TARGET_INCLUDE_DIRECTORIES}/${PROJECT_NAME}/numeric_types.h\"
#include \"${AE_TARGET_INCLUDE_DIRECTORIES}/${PROJECT_NAME}/numeric_limit.h\"
