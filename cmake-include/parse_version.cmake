...
set(AE_VERSION_MAJOR ${AE_VERSION_MAJOR} CACHE STRING "ae major version component" FORCE)

# Сохраняем минорную версию в кэш.
set(AE_VERSION_MINOR ${AE_VERSION_MINOR} CACHE STRING "ae minor version component" FORCE)

# Сохраняем патч-версию в кэш.
set(AE_VERSION_PATCH ${AE_VERSION_PATCH} CACHE STRING "ae patch version component" FORCE)
