...
# Проверяем, есть ли макрос "AE_LIBRARY_OPTION_STATIC_BUILD" в списке AE_TARGET_PRIVATE_COMPILE_DEFINITIONS
list(FIND AE_TARGET_PRIVATE_COMPILE_DEFINITIONS "AE_LIBRARY_OPTION_STATIC_BUILD" index)
...
if (index GREATER -1)
    ...
    list(APPEND AE_TARGET_PUBLIC_COMPILE_DEFINITIONS "AE_LIBRARY_OPTION_STATIC_BUILD")

    # Удаляем макрос из приватного списка, так как он должен быть доступен и для другого проекта
    list(REMOVE_AT AE_TARGET_PRIVATE_COMPILE_DEFINITIONS ${index})
endif ()